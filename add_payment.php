...
if (isset($_REQUEST['payment'])) {
  ...
  $yoga_id = mysqli_real_escape_string($conn, $_REQUEST['yoga_id']);
  ...
  if (count($errors) == 0) {
    ...
    $query = "INSERT INTO payment (pay_id,amount,yoga_id) 
          VALUES('$pay_id','$amount','$yoga_id')";
...
<div class="container">
  <form class="mt-3 form-group" method="post" action="">
    ...
    <input type="text" name="yoga_id" class="form-control">
