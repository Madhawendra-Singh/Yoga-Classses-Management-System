...
<body style="background:url(yoga.jpg);">
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <div class="container-fluid">
  <a class="navbar-brand" href="home.php">YOGA MANAGEMENT SYSTEM</a>
  ...
  <div class="col-2">
    ...
    <div class="list-group">
      <div class="list-group-item bg-dark">
        ...
        <i class="fas fa-user-alt"></i>  YOGA</a>
      </div>
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=add_yoga" class="text-light">ADD YOGA</a>
          </div>
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=manage_yoga" class="text-light">VIEW YOGAS</a></div>
        </div>
      <div class="list-group-item bg-dark">
...
if ($info!=="") {
             ...
             }elseif ($info=="manage_yoga") {
               include ('manage_yoga.php');
             }elseif ($info=="update_payment") {
               include ('update_payment.php');
             }elseif ($info=="delete_payment") {
               include ('delete_payment.php');
             }elseif ($info=="update_yoga") {
               include ('update_yoga.php');
             }elseif ($info=="delete_yoga") {
               include ('delete_yoga.php');
             ...
             }elseif ($info=="yoga_search") {
               include ('yoga_search.php');
